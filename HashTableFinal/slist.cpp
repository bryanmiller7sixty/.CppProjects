...
//Search method used for the first version of the slist, changed to take an el_t element.
...
/*
Parameters: The position in the list, requested to be returned, as well as the count in the list.
Purpose: Loop throught the list, until position of the element is reached, return that element.
*/
el_t slist::returnIth(int stopNum, int count){
  Node *temp = Front;
  el_t tempObj;
